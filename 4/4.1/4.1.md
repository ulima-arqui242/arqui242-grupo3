...
### Módulo de Seguridad - Escenario de Autenticación
...
**Contexto**:  
La aplicación de salones de belleza experimenta picos de tráfico durante campañas promocionales o eventos especiales. El servicio de autenticación es un punto crítico que debe mantenerse disponible y responsivo para garantizar una experiencia fluida a los usuarios, incluso en momentos de alta demanda.
...
**Decisión**:  
- Se elige el **Balanceo de Carga con Escalado Automático**.
