...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo** | **Fuente del Estímulo** | **Artefacto** | **Entorno**  | **Respuesta** | **Medida de Respuesta**  |
|-------------|---------------|---------------------------------|-------------------------------------|-----------------------------------|--------------------------------------------------|---------------------------------------------------|
| **ESC-02** | **Disponibilidad** | Revisión de notificaciones sin leer | Equipo desarrollador | Módulo de Gestión de Notificaciones| Alta demanda | Se muestran sus notificaciones sin leer| El sistema funciona y mantiene una disponibilidad de 99.9% de las notificaciones sin leer que sigan siendo relevantes 
### Táctica Elegida
