...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo**                           | **Fuente del Estímulo** | **Artefacto**                  | **Entorno**                         | **Respuesta**                                                | **Medida de Respuesta**                             |
|------------------|-------------------------|----------------------------------------|-------------------------|--------------------------------|-------------------------------------|-------------------------------------------------------------|-----------------------------------------------------|
| ESC-02         | Disponibilidad           | Falla en la infraestructura de almacenamiento de S3 (Amazon Web Services)  |AWS (S3 - Almacenamiento en la nube)   | Módulo de Gestión de Ofertas | Operación durante promociones masivas (ej. fiestas patrias) | El sistema continúa funcionando sin interrupciones y las ofertas siguen siendo visibles. | El sistema mantiene una disponibilidad del 99.9% anual. |
