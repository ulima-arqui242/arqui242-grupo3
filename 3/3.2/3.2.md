...
## ADR 3: Comunicación Síncrona entre Microservicios - REST vs gRPC
...
## ADR 4: Comunicación Asíncrona entre Microservicios - Plataforma Distribuida de Transmisión de Datos vs Plataforma de Mensajería de Colas

### Contexto

La plataforma de InStudio requiere una forma de comunicación entre microservicios que permita la transmisión de eventos en tiempo real. La elección del protocolo de comunicación asíncrona impactará la latencia, la escalabilidad y la resiliencia del sistema.

### Alternativas

#### Plataforma Distribuida de Transmisión de Datos (ej: Kafka)

- **Ventajas**:
  - Permite la comunicación asíncrona, donde los servicios no necesitan esperar respuestas inmediatas.
  - Alta escalabilidad, capaz de manejar grandes volúmenes de eventos y datos de manera eficiente.
  - Resiliencia, permitiendo que los servicios consuman mensajes incluso si están temporalmente fuera de línea.
  - Persistencia de mensajes, asegurando que no se pierdan eventos incluso ante fallos del sistema.
  - Soporta un modelo de publicación/suscripción, facilitando la distribución de eventos a múltiples consumidores.

- **Desventajas**:
  - Complejidad en la implementación y gestión, ya que requiere configurar brokers, particiones y consumidores.
  - Puede requerir más recursos en términos de infraestructura.

#### Plataforma de Mensajería de Colas

- **Ventajas**:
  - Facilita la comunicación asíncrona y la desconexión entre servicios, permitiendo un desacoplamiento eficiente.
  - Generalmente más fácil de implementar y gestionar, ideal para sistemas menos complejos.
  - Buen manejo de la entrega de mensajes, garantizando que los mensajes sean entregados en orden y sin duplicados.

- **Desventajas**:
  - Puede tener limitaciones en escalabilidad para grandes volúmenes de datos.
  - Menos eficiente en la gestión de eventos en tiempo real en comparación con Kafka, especialmente en situaciones de alta carga.
  - Persistencia de mensajes puede no ser tan robusta como en Kafka, lo que podría resultar en pérdida de eventos bajo ciertas condiciones.

### Criterios de Elección

- Volumen de tráfico y escalabilidad requerida.
- Resiliencia del sistema ante fallos o interrupciones.
- Complejidad de implementación y mantenimiento a largo plazo.

### Decisión

Se elige implementar **Kafka** para la comunicación asíncrona entre microservicios.

### Sustento

Kafka es más adecuado para manejar grandes volúmenes de eventos y permite una comunicación asíncrona eficiente, con alta escalabilidad y resiliencia ante fallos. Aunque una plataforma de mensajería de colas ofrece facilidad de uso y buena entrega de mensajes, sus limitaciones en escalabilidad y persistencia la hacen menos apropiada para las necesidades de la plataforma.
