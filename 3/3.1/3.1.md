...
#### Decisión
Se elige el job diario.

#### Sustento
El job diario cumple con los requisitos del negocio de proporcionar datos para análisis estratégico sin la necesidad de procesamiento en tiempo real. Se ejecuta en momento con poco tráfico en la aplicación por lo que se asegura la consistencia de los datos.
