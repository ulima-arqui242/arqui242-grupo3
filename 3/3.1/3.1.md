...
El almacenamiento de las ofertas requiere ser lo suficientemente flexible y mantenible como para manejar diferentes tipos de promociones, lo que puede implicar múltiples campos y estructuras de datos, dependiendo del tipo de oferta. Además, debe ofrecer un acceso eficiente y poder añadir facilmente nuevas propiedades sin migraciones o modificaciones complejas.
