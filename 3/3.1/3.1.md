...
#### Decisión
Se elige el Monitoreo Diario.

#### Sustento
En este contexto es preferible un monitoreo diario porque las decisiones estratégicas, como la creación de ofertas, campañas de marketing y ajustes de servicios, no requieren datos en tiempo real, sino un análisis de tendencias basado en datos acumulados. Además, la actualización diaria proporciona una mayor estabilidad del sistema y menores costos operativos. Si bien el monitoreo en tiempo real podría ofrecer ventajas en situaciones excepcionales, el valor añadido no compensa la complejidad técnica y el costo adicional que implica su implementación.

### 2) Titulo: Elección entre base de datos SQL y NoSQL

fasfsasdf asdf asd fas dfa sdf asd fasd f
