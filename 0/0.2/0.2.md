...
- Solución: Se usa el patron cloud de Suscriber y Publisher para que las personas suscritas a recibir notificaciones, las reciban. Se guarda en el dynamodb y en el mismo SNS si es que pueden recibir notificaciones
- Casos de aplicación:
